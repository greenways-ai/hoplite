...
/*
 * Every descriptor is request- or response-scoped and owned by the native
 * host. The Rust bridge never interprets context as a path, URL, file
 * descriptor, credential, or portable application value.
 */
