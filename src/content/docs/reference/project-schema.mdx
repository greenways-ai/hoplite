 ...
 {:extension/hoplite
  {:hoplite/modules
   [{:module/id "gh:greenways-ai:hoplite"
    ...
    {:module/id "gh:greenways-ai:hoplite-store-memory"
     :module/version "0.1.0"
...
before the management gateway starts. The gateway rejects missing aliases and
installed runtimes reject store packages they cannot execute; there is no
silent fallback after an explicit adapter is selected.
