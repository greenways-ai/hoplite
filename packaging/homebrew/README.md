...
2. resolves one immutable Hara revision and reuses it in every job;
...
The workflow can also be run manually against an existing tag. This is useful for rebuilding an older tag after release automation changes without moving or recreating that tag.
